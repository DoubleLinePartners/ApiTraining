  ...
  namespace EdFi.Rest.Api {
    public class LearningStandardsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<LearningStandard>> GetLearningStandardsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<LearningStandard>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<LearningStandard> GetLearningStandardByKey(string learningStandardId, string IfNoneMatch) {
        var request = new RestRequest("/learningStandards", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<LearningStandard>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<LearningStandard> GetLearningStandardsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteLearningStandardById(string id, string IfMatch) {
