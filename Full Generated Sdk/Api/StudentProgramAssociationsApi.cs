  ...
  namespace EdFi.Rest.Api {
    public class StudentProgramAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentProgramAssociation>> GetStudentProgramAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentProgramAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentProgramAssociation> GetStudentProgramAssociationByKey(string studentUniqueId, string programType, string programName, int? programEducationOrganizationId, DateTime? beginDate, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/studentProgramAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentProgramAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentProgramAssociation> GetStudentProgramAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentProgramAssociationById(string id, string IfMatch) {
