  ...
  namespace EdFi.Rest.Api {
    public class FeederSchoolAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<FeederSchoolAssociation>> GetFeederSchoolAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<FeederSchoolAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <param name="beginDate">The month, day, and year of the first dat of the feeder school association.</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<FeederSchoolAssociation> GetFeederSchoolAssociationByKey(int? schoolId, int? feederSchoolId, DateTime? beginDate, string IfNoneMatch) {
        var request = new RestRequest("/feederSchoolAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || feederSchoolId == null || beginDate == null ) {
        ...
        return client.Execute<FeederSchoolAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<FeederSchoolAssociation> GetFeederSchoolAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteFeederSchoolAssociationById(string id, string IfMatch) {
