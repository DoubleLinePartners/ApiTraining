  ...
  namespace EdFi.Rest.Api {
    public class SessionsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Session>> GetSessionsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Session>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Session> GetSessionByKey(int? schoolId, string termType, int? schoolYear, string IfNoneMatch) {
        var request = new RestRequest("/sessions", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || termType == null || schoolYear == null ) {
        ...
        return client.Execute<Session>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Session> GetSessionsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSessionById(string id, string IfMatch) {
