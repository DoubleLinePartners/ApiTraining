  ...
  namespace EdFi.Rest.Api {
    public class StudentMigrantEducationProgramAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentMigrantEducationProgramAssociation>> GetStudentMigrantEducationProgramAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentMigrantEducationProgramAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentMigrantEducationProgramAssociation> GetStudentMigrantEducationProgramAssociationByKey(string studentUniqueId, string programType, int? programEducationOrganizationId, DateTime? beginDate, string programName, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/studentMigrantEducationProgramAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentMigrantEducationProgramAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentMigrantEducationProgramAssociation> GetStudentMigrantEducationProgramAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentMigrantEducationProgramAssociationById(string id, string IfMatch) {
