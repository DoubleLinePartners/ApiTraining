  ...
  namespace EdFi.Rest.Api {
    public class StaffEducationOrganizationEmploymentAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StaffEducationOrganizationEmploymentAssociation>> GetStaffEducationOrganizationEmploymentAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StaffEducationOrganizationEmploymentAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <param name="hireDate">The month, day, and year on which a contract between an individual and a governing authority specifies that employment is to begin (or the date on which the agreement is made valid).  NEDM: Contract Beginning Date</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StaffEducationOrganizationEmploymentAssociation> GetStaffEducationOrganizationEmploymentAssociationByKey(string staffUniqueId, int? educationOrganizationId, string employmentStatusDescriptor, DateTime? hireDate, string IfNoneMatch) {
        var request = new RestRequest("/staffEducationOrganizationEmploymentAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StaffEducationOrganizationEmploymentAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StaffEducationOrganizationEmploymentAssociation> GetStaffEducationOrganizationEmploymentAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStaffEducationOrganizationEmploymentAssociationById(string id, string IfMatch) {
