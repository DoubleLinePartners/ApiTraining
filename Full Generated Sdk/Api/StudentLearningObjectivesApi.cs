  ...
  namespace EdFi.Rest.Api {
    public class StudentLearningObjectivesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentLearningObjective>> GetStudentLearningObjectivesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentLearningObjective>>(request);   
      }
      /// <summary>
      ...
      /// <param name="gradingPeriodEducationOrganizationId"></param>
      /// <param name="gradingPeriodDescriptor"></param>
      /// <param name="gradingPeriodBeginDate"></param>
      ...
      /// <returns></returns>
      public IRestResponse<StudentLearningObjective> GetStudentLearningObjectiveByKey(string studentUniqueId, int? gradingPeriodEducationOrganizationId, string gradingPeriodDescriptor, DateTime? gradingPeriodBeginDate, string objective, string academicSubjectDescriptor, string objectiveGradeLevelDescriptor, string IfNoneMatch) {
        var request = new RestRequest("/studentLearningObjectives", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || gradingPeriodEducationOrganizationId == null || gradingPeriodDescriptor == null || gradingPeriodBeginDate == null || objective == null || academicSubjectDescriptor == null || objectiveGradeLevelDescriptor == null ) {
        ...
        return client.Execute<StudentLearningObjective>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentLearningObjective> GetStudentLearningObjectivesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentLearningObjectiveById(string id, string IfMatch) {
