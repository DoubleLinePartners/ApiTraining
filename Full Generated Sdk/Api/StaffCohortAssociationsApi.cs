  ...
  namespace EdFi.Rest.Api {
    public class StaffCohortAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StaffCohortAssociation>> GetStaffCohortAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StaffCohortAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <param name="beginDate">The start date the staff was associated with the cohort.  </param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StaffCohortAssociation> GetStaffCohortAssociationByKey(string staffUniqueId, int? educationOrganizationId, string cohortIdentifier, DateTime? beginDate, string IfNoneMatch) {
        var request = new RestRequest("/staffCohortAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StaffCohortAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StaffCohortAssociation> GetStaffCohortAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStaffCohortAssociationById(string id, string IfMatch) {
