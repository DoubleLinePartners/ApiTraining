  ...
  namespace EdFi.Rest.Api {
    public class StudentAcademicRecordsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentAcademicRecord>> GetStudentAcademicRecordsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentAcademicRecord>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentAcademicRecord> GetStudentAcademicRecordByKey(string studentUniqueId, int? educationOrganizationId, int? schoolYear, string termType, string IfNoneMatch) {
        var request = new RestRequest("/studentAcademicRecords", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || educationOrganizationId == null || schoolYear == null || termType == null ) {
        ...
        return client.Execute<StudentAcademicRecord>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentAcademicRecord> GetStudentAcademicRecordsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentAcademicRecordById(string id, string IfMatch) {
