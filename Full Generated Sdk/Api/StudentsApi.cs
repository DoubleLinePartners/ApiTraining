  ...
  namespace EdFi.Rest.Api {
    public class StudentsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Student>> GetStudentsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Student>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Student> GetStudentByKey(string studentUniqueId, string IfNoneMatch) {
        var request = new RestRequest("/students", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Student>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Student> GetStudentsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentById(string id, string IfMatch) {
