  ...
  namespace EdFi.Rest.Api {
    public class DiplomaLevelTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<DiplomaLevelType>> GetDiplomaLevelTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<DiplomaLevelType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<DiplomaLevelType> GetDiplomaLevelTypeByKey(int? diplomaLevelTypeId, string IfNoneMatch) {
        var request = new RestRequest("/diplomaLevelTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<DiplomaLevelType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DiplomaLevelType> GetDiplomaLevelTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteDiplomaLevelTypeById(string id, string IfMatch) {
