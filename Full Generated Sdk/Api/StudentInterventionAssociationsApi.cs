  ...
  namespace EdFi.Rest.Api {
    public class StudentInterventionAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentInterventionAssociation>> GetStudentInterventionAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentInterventionAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentInterventionAssociation> GetStudentInterventionAssociationByKey(string studentUniqueId, string interventionIdentificationCode, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/studentInterventionAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentInterventionAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentInterventionAssociation> GetStudentInterventionAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentInterventionAssociationById(string id, string IfMatch) {
