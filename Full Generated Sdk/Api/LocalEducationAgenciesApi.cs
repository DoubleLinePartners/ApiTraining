  ...
  namespace EdFi.Rest.Api {
    public class LocalEducationAgenciesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<LocalEducationAgency>> GetLocalEducationAgenciesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<LocalEducationAgency>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<LocalEducationAgency> GetLocalEducationAgencyByKey(int? localEducationAgencyId, string IfNoneMatch) {
        var request = new RestRequest("/localEducationAgencies", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<LocalEducationAgency>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<LocalEducationAgency> GetLocalEducationAgenciesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteLocalEducationAgencyById(string id, string IfMatch) {
