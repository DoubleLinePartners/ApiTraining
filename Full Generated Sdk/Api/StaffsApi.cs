  ...
  namespace EdFi.Rest.Api {
    public class StaffsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Staff>> GetStaffsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Staff>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Staff> GetStaffByKey(string staffUniqueId, string IfNoneMatch) {
        var request = new RestRequest("/staffs", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Staff>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Staff> GetStaffsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStaffById(string id, string IfMatch) {
