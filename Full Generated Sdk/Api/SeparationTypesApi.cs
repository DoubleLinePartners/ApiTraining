  ...
  namespace EdFi.Rest.Api {
    public class SeparationTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<SeparationType>> GetSeparationTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<SeparationType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<SeparationType> GetSeparationTypeByKey(int? separationTypeId, string IfNoneMatch) {
        var request = new RestRequest("/separationTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<SeparationType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<SeparationType> GetSeparationTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSeparationTypeById(string id, string IfMatch) {
