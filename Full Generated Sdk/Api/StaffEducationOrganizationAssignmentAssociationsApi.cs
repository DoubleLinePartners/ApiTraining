  ...
  namespace EdFi.Rest.Api {
    public class StaffEducationOrganizationAssignmentAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StaffEducationOrganizationAssignmentAssociation>> GetStaffEducationOrganizationAssignmentAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StaffEducationOrganizationAssignmentAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StaffEducationOrganizationAssignmentAssociation> GetStaffEducationOrganizationAssignmentAssociationByKey(string staffUniqueId, int? educationOrganizationId, string staffClassificationDescriptor, DateTime? beginDate, string IfNoneMatch) {
        var request = new RestRequest("/staffEducationOrganizationAssignmentAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StaffEducationOrganizationAssignmentAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StaffEducationOrganizationAssignmentAssociation> GetStaffEducationOrganizationAssignmentAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStaffEducationOrganizationAssignmentAssociationById(string id, string IfMatch) {
