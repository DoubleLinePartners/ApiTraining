  ...
  namespace EdFi.Rest.Api {
    public class CourseOfferingsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<CourseOffering>> GetCourseOfferingsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<CourseOffering>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<CourseOffering> GetCourseOfferingByKey(int? schoolId, string termType, int? schoolYear, string localCourseCode, string IfNoneMatch) {
        var request = new RestRequest("/courseOfferings", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || termType == null || schoolYear == null || localCourseCode == null ) {
        ...
        return client.Execute<CourseOffering>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<CourseOffering> GetCourseOfferingsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteCourseOfferingById(string id, string IfMatch) {
