  ...
  namespace EdFi.Rest.Api {
    public class DisciplineActionsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<DisciplineAction>> GetDisciplineActionsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<DisciplineAction>>(request);   
      }
      /// <summary>
      ...
      /// <param name="disciplineDate">Month, day and year of the discipline action.</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DisciplineAction> GetDisciplineActionByKey(string studentUniqueId, string identifier, DateTime? disciplineDate, string IfNoneMatch) {
        var request = new RestRequest("/disciplineActions", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || identifier == null || disciplineDate == null ) {
        ...
        return client.Execute<DisciplineAction>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DisciplineAction> GetDisciplineActionsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteDisciplineActionById(string id, string IfMatch) {
