  ...
  namespace EdFi.Rest.Api {
    public class StudentParentAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentParentAssociation>> GetStudentParentAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentParentAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentParentAssociation> GetStudentParentAssociationByKey(string studentUniqueId, string parentUniqueId, string IfNoneMatch) {
        var request = new RestRequest("/studentParentAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentParentAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentParentAssociation> GetStudentParentAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentParentAssociationById(string id, string IfMatch) {
