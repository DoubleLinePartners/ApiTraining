  ...
  namespace EdFi.Rest.Api {
    public class AccountsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Account>> GetAccountsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Account>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Account> GetAccountByKey(int? educationOrganizationId, string number, int? fiscalYear, string IfNoneMatch) {
        var request = new RestRequest("/accounts", Method.GET);
        request.RequestFormat = DataFormat.Json;
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Account> GetAccountsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteAccountById(string id, string IfMatch) {
