  ...
  namespace EdFi.Rest.Api {
    public class SectionsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Section>> GetSectionsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Section>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Section> GetSectionByKey(int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, string IfNoneMatch) {
        var request = new RestRequest("/sections", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null ) {
        ...
        return client.Execute<Section>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Section> GetSectionsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSectionById(string id, string IfMatch) {
