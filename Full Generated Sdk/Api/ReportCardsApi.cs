  ...
  namespace EdFi.Rest.Api {
    public class ReportCardsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<ReportCard>> GetReportCardsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<ReportCard>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<ReportCard> GetReportCardByKey(string studentUniqueId, int? educationOrganizationId, int? gradingPeriodEducationOrganizationId, string gradingPeriodDescriptor, DateTime? gradingPeriodBeginDate, string IfNoneMatch) {
        var request = new RestRequest("/reportCards", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || educationOrganizationId == null || gradingPeriodEducationOrganizationId == null || gradingPeriodDescriptor == null || gradingPeriodBeginDate == null ) {
        ...
        return client.Execute<ReportCard>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<ReportCard> GetReportCardsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteReportCardById(string id, string IfMatch) {
