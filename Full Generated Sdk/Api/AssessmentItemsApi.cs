  ...
  namespace EdFi.Rest.Api {
    public class AssessmentItemsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<AssessmentItem>> GetAssessmentItemsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<AssessmentItem>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<AssessmentItem> GetAssessmentItemByKey(string assessmentTitle, string academicSubjectDescriptor, string assessedGradeLevelDescriptor, int? version, string identificationCode, string IfNoneMatch) {
        var request = new RestRequest("/assessmentItems", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<AssessmentItem>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<AssessmentItem> GetAssessmentItemsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteAssessmentItemById(string id, string IfMatch) {
