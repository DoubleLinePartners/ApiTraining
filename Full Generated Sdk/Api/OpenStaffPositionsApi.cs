  ...
  namespace EdFi.Rest.Api {
    public class OpenStaffPositionsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<OpenStaffPosition>> GetOpenStaffPositionsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<OpenStaffPosition>>(request);   
      }
      /// <summary>
      ...
      /// <param name="datePosted">The date the position was posted.  </param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<OpenStaffPosition> GetOpenStaffPositionByKey(int? educationOrganizationId, string employmentStatusDescriptor, string staffClassificationDescriptor, string requisitionNumber, DateTime? datePosted, string IfNoneMatch) {
        var request = new RestRequest("/openStaffPositions", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<OpenStaffPosition>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<OpenStaffPosition> GetOpenStaffPositionsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteOpenStaffPositionById(string id, string IfMatch) {
