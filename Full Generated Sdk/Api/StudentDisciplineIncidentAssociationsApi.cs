  ...
  namespace EdFi.Rest.Api {
    public class StudentDisciplineIncidentAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentDisciplineIncidentAssociation>> GetStudentDisciplineIncidentAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentDisciplineIncidentAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentDisciplineIncidentAssociation> GetStudentDisciplineIncidentAssociationByKey(string studentUniqueId, int? schoolId, string incidentIdentifier, string IfNoneMatch) {
        var request = new RestRequest("/studentDisciplineIncidentAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentDisciplineIncidentAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentDisciplineIncidentAssociation> GetStudentDisciplineIncidentAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentDisciplineIncidentAssociationById(string id, string IfMatch) {
