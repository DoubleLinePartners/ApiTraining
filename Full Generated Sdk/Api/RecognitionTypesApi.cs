  ...
  namespace EdFi.Rest.Api {
    public class RecognitionTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<RecognitionType>> GetRecognitionTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<RecognitionType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<RecognitionType> GetRecognitionTypeByKey(int? recognitionTypeId, string IfNoneMatch) {
        var request = new RestRequest("/recognitionTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<RecognitionType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<RecognitionType> GetRecognitionTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteRecognitionTypeById(string id, string IfMatch) {
