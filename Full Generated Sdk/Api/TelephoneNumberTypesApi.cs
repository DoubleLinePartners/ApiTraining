  ...
  namespace EdFi.Rest.Api {
    public class TelephoneNumberTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<TelephoneNumberType>> GetTelephoneNumberTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<TelephoneNumberType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<TelephoneNumberType> GetTelephoneNumberTypeByKey(int? telephoneNumberTypeId, string IfNoneMatch) {
        var request = new RestRequest("/telephoneNumberTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<TelephoneNumberType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<TelephoneNumberType> GetTelephoneNumberTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteTelephoneNumberTypeById(string id, string IfMatch) {
