  ...
  namespace EdFi.Rest.Api {
    public class GradebookEntriesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<GradebookEntry>> GetGradebookEntriesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<GradebookEntry>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<GradebookEntry> GetGradebookEntryByKey(int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, string title, DateTime? dateAssigned, string IfNoneMatch) {
        var request = new RestRequest("/gradebookEntries", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null || title == null || dateAssigned == null ) {
        ...
        return client.Execute<GradebookEntry>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<GradebookEntry> GetGradebookEntriesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteGradebookEntryById(string id, string IfMatch) {
