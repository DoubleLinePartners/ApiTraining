  ...
  namespace EdFi.Rest.Api {
    public class StudentEducationOrganizationAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentEducationOrganizationAssociation>> GetStudentEducationOrganizationAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentEducationOrganizationAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentEducationOrganizationAssociation> GetStudentEducationOrganizationAssociationByKey(string studentUniqueId, int? educationOrganizationId, string responsibilityDescriptor, string IfNoneMatch) {
        var request = new RestRequest("/studentEducationOrganizationAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentEducationOrganizationAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentEducationOrganizationAssociation> GetStudentEducationOrganizationAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentEducationOrganizationAssociationById(string id, string IfMatch) {
