  ...
  namespace EdFi.Rest.Api {
    public class StudentSectionAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentSectionAssociation>> GetStudentSectionAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentSectionAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentSectionAssociation> GetStudentSectionAssociationByKey(string studentUniqueId, int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, DateTime? beginDate, string IfNoneMatch) {
        var request = new RestRequest("/studentSectionAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null || beginDate == null ) {
        ...
        return client.Execute<StudentSectionAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSectionAssociation> GetStudentSectionAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentSectionAssociationById(string id, string IfMatch) {
