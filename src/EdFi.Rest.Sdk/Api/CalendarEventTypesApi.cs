  ...
  namespace EdFi.Rest.Api {
    public class CalendarEventTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<CalendarEventType>> GetCalendarEventTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<CalendarEventType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<CalendarEventType> GetCalendarEventTypeByKey(int? calendarEventTypeId, string IfNoneMatch) {
        var request = new RestRequest("/calendarEventTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<CalendarEventType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<CalendarEventType> GetCalendarEventTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteCalendarEventTypeById(string id, string IfMatch) {
