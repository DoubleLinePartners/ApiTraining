  ...
  namespace EdFi.Rest.Api {
    public class StudentSchoolAttendanceEventsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentSchoolAttendanceEvent>> GetStudentSchoolAttendanceEventsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentSchoolAttendanceEvent>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentSchoolAttendanceEvent> GetStudentSchoolAttendanceEventByKey(string studentUniqueId, int? schoolId, string termType, int? schoolYear, DateTime? eventDate, string attendanceEventCategoryDescriptor, string IfNoneMatch) {
        var request = new RestRequest("/studentSchoolAttendanceEvents", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || schoolId == null || termType == null || schoolYear == null || eventDate == null || attendanceEventCategoryDescriptor == null ) {
        ...
        return client.Execute<StudentSchoolAttendanceEvent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSchoolAttendanceEvent> GetStudentSchoolAttendanceEventsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentSchoolAttendanceEventById(string id, string IfMatch) {
