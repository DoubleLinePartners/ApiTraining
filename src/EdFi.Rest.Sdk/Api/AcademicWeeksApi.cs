  ...
  namespace EdFi.Rest.Api {
    public class AcademicWeeksApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<AcademicWeek>> GetAcademicWeeksAll(int? offset, int? limit) {
        ...
        return client.Execute<List<AcademicWeek>>(request);   
      }
      /// <summary>
      /// Retrieves a specific resource using the values of the resource's natural key (using the &quot;Get By Key&quot; pattern). This GET operation provides access to resources using the &quot;Get by Key&quot; search pattern. The values of the natural key of the resource must be fully specified, and the service will return the matching result (if it exists).
      /// </summary>
      /// <param name="weekIdentifier">The campus label for the week.  </param>
      /// <param name="educationOrganizationId">EducationOrganization Identity Column</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<AcademicWeek> GetAcademicWeekByKey(string weekIdentifier, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/academicWeeks", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (weekIdentifier == null || educationOrganizationId == null ) {
        ...
        return client.Execute<AcademicWeek>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<AcademicWeek> GetAcademicWeeksById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteAcademicWeekById(string id, string IfMatch) {
