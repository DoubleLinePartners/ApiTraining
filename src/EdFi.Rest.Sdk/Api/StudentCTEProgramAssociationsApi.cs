  ...
  namespace EdFi.Rest.Api {
    public class StudentCTEProgramAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentCTEProgramAssociation>> GetStudentCTEProgramAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentCTEProgramAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentCTEProgramAssociation> GetStudentCTEProgramAssociationByKey(string studentUniqueId, string programType, string programName, int? programEducationOrganizationId, DateTime? beginDate, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/studentCTEProgramAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || programType == null || programName == null || programEducationOrganizationId == null || beginDate == null || educationOrganizationId == null ) {
        ...
        return client.Execute<StudentCTEProgramAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentCTEProgramAssociation> GetStudentCTEProgramAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentCTEProgramAssociationById(string id, string IfMatch) {
