  ...
  namespace EdFi.Rest.Api {
    public class EducationContentsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<EducationContent>> GetEducationContentsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<EducationContent>>(request);   
      }
      /// <summary>
      /// Retrieves a specific resource using the values of the resource's natural key (using the &quot;Get By Key&quot; pattern). This GET operation provides access to resources using the &quot;Get by Key&quot; search pattern. The values of the natural key of the resource must be fully specified, and the service will return the matching result (if it exists).
      /// </summary>
      /// <param name="contentIdentifier">A unique identifier for the content.</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<EducationContent> GetEducationContentByKey(string contentIdentifier, string IfNoneMatch) {
        var request = new RestRequest("/educationContents", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<EducationContent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<EducationContent> GetEducationContentsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteEducationContentById(string id, string IfMatch) {
