  ...
  namespace EdFi.Rest.Api {
    public class SectionAttendanceTakenEventsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<SectionAttendanceTakenEvent>> GetSectionAttendanceTakenEventsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<SectionAttendanceTakenEvent>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<SectionAttendanceTakenEvent> GetSectionAttendanceTakenEventByKey(int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, DateTime? date, string IfNoneMatch) {
        var request = new RestRequest("/sectionAttendanceTakenEvents", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null || date == null ) {
        ...
        return client.Execute<SectionAttendanceTakenEvent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<SectionAttendanceTakenEvent> GetSectionAttendanceTakenEventsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSectionAttendanceTakenEventById(string id, string IfMatch) {
