  ...
  namespace EdFi.Rest.Api {
    public class LeaveEventsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<LeaveEvent>> GetLeaveEventsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<LeaveEvent>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<LeaveEvent> GetLeaveEventByKey(string staffUniqueId, DateTime? eventDate, string categoryType, string IfNoneMatch) {
        var request = new RestRequest("/leaveEvents", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<LeaveEvent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<LeaveEvent> GetLeaveEventsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteLeaveEventById(string id, string IfMatch) {
