  ...
  namespace EdFi.Rest.Api {
    public class ParentsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Parent>> GetParentsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Parent>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Parent> GetParentByKey(string parentUniqueId, string IfNoneMatch) {
        var request = new RestRequest("/parents", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Parent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Parent> GetParentsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteParentById(string id, string IfMatch) {
