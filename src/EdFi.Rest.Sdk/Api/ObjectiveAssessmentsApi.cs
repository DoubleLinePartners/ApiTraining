  ...
  namespace EdFi.Rest.Api {
    public class ObjectiveAssessmentsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<ObjectiveAssessment>> GetObjectiveAssessmentsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<ObjectiveAssessment>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<ObjectiveAssessment> GetObjectiveAssessmentByKey(string assessmentTitle, string academicSubjectDescriptor, string assessedGradeLevelDescriptor, int? version, string identificationCode, string IfNoneMatch) {
        var request = new RestRequest("/objectiveAssessments", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<ObjectiveAssessment>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<ObjectiveAssessment> GetObjectiveAssessmentsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteObjectiveAssessmentById(string id, string IfMatch) {
