  ...
  namespace EdFi.Rest.Api {
    public class SchoolYearTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<SchoolYearType>> GetSchoolYearTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<SchoolYearType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<SchoolYearType> GetSchoolYearTypeByKey(int? schoolYear, string IfNoneMatch) {
        var request = new RestRequest("/schoolYearTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<SchoolYearType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<SchoolYearType> GetSchoolYearTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSchoolYearTypeById(string id, string IfMatch) {
