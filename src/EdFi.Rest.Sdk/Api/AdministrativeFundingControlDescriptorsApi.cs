  ...
  namespace EdFi.Rest.Api {
    public class AdministrativeFundingControlDescriptorsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<AdministrativeFundingControlDescriptor>> GetAdministrativeFundingControlDescriptorsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<AdministrativeFundingControlDescriptor>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<AdministrativeFundingControlDescriptor> GetAdministrativeFundingControlDescriptorByKey(int? administrativeFundingControlDescriptorId, string IfNoneMatch) {
        var request = new RestRequest("/administrativeFundingControlDescriptors", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<AdministrativeFundingControlDescriptor>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<AdministrativeFundingControlDescriptor> GetAdministrativeFundingControlDescriptorsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteAdministrativeFundingControlDescriptorById(string id, string IfMatch) {
