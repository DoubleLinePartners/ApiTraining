  ...
  namespace EdFi.Rest.Api {
    public class RestraintEventsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<RestraintEvent>> GetRestraintEventsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<RestraintEvent>>(request);   
      }
      /// <summary>
      ...
      /// <param name="eventDate">Month, day and year of the resteraint event.  </param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<RestraintEvent> GetRestraintEventByKey(string studentUniqueId, int? schoolId, string identifier, DateTime? eventDate, string IfNoneMatch) {
        var request = new RestRequest("/restraintEvents", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<RestraintEvent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<RestraintEvent> GetRestraintEventsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteRestraintEventById(string id, string IfMatch) {
