  ...
  namespace EdFi.Rest.Api {
    public class SchoolTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<SchoolType>> GetSchoolTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<SchoolType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<SchoolType> GetSchoolTypeByKey(int? schoolTypeId, string IfNoneMatch) {
        var request = new RestRequest("/schoolTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<SchoolType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<SchoolType> GetSchoolTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSchoolTypeById(string id, string IfMatch) {
