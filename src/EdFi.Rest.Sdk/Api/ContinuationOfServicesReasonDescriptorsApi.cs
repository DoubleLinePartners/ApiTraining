  ...
  namespace EdFi.Rest.Api {
    public class ContinuationOfServicesReasonDescriptorsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<ContinuationOfServicesReasonDescriptor>> GetContinuationOfServicesReasonDescriptorsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<ContinuationOfServicesReasonDescriptor>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<ContinuationOfServicesReasonDescriptor> GetContinuationOfServicesReasonDescriptorByKey(int? continuationOfServicesReasonDescriptorId, string IfNoneMatch) {
        var request = new RestRequest("/continuationOfServicesReasonDescriptors", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<ContinuationOfServicesReasonDescriptor>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<ContinuationOfServicesReasonDescriptor> GetContinuationOfServicesReasonDescriptorsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteContinuationOfServicesReasonDescriptorById(string id, string IfMatch) {
