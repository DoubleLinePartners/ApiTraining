  ...
  namespace EdFi.Rest.Api {
    public class DiagnosisTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<DiagnosisType>> GetDiagnosisTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<DiagnosisType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<DiagnosisType> GetDiagnosisTypeByKey(int? diagnosisTypeId, string IfNoneMatch) {
        var request = new RestRequest("/diagnosisTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<DiagnosisType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DiagnosisType> GetDiagnosisTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteDiagnosisTypeById(string id, string IfMatch) {
