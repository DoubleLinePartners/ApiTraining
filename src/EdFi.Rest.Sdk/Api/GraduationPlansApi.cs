  ...
  namespace EdFi.Rest.Api {
    public class GraduationPlansApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<GraduationPlan>> GetGraduationPlansAll(int? offset, int? limit) {
        ...
        return client.Execute<List<GraduationPlan>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<GraduationPlan> GetGraduationPlanByKey(int? educationOrganizationId, string typeDescriptor, int? graduationSchoolYear, string IfNoneMatch) {
        var request = new RestRequest("/graduationPlans", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (educationOrganizationId == null || typeDescriptor == null || graduationSchoolYear == null ) {
        ...
        return client.Execute<GraduationPlan>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<GraduationPlan> GetGraduationPlansById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteGraduationPlanById(string id, string IfMatch) {
