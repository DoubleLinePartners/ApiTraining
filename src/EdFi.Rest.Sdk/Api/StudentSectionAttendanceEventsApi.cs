  ...
  namespace EdFi.Rest.Api {
    public class StudentSectionAttendanceEventsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentSectionAttendanceEvent>> GetStudentSectionAttendanceEventsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentSectionAttendanceEvent>>(request);   
      }
      /// <summary>
      ...
      /// <param name="attendanceEventCategoryDescriptor">A code describing the type of the attendance event.  In Attendance  Absence  Excused Absence  Unexcused Absence  Tardy  Early departure  NEDM: Attendance Event Category  </param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSectionAttendanceEvent> GetStudentSectionAttendanceEventByKey(string studentUniqueId, int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, DateTime? eventDate, string attendanceEventCategoryDescriptor, string IfNoneMatch) {
        var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null || eventDate == null || attendanceEventCategoryDescriptor == null ) {
        ...
        return client.Execute<StudentSectionAttendanceEvent>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSectionAttendanceEvent> GetStudentSectionAttendanceEventsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentSectionAttendanceEventById(string id, string IfMatch) {
