  ...
  namespace EdFi.Rest.Api {
    public class StudentSchoolAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentSchoolAssociation>> GetStudentSchoolAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentSchoolAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <param name="entryDate">The month, day, and year on which an individual enters and begins to receive instructional services in a campus.  NEDM: School Entry Date  NEDM: LEA Entry Date  </param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSchoolAssociation> GetStudentSchoolAssociationByKey(string studentUniqueId, int? schoolId, DateTime? entryDate, string IfNoneMatch) {
        var request = new RestRequest("/studentSchoolAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentSchoolAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentSchoolAssociation> GetStudentSchoolAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentSchoolAssociationById(string id, string IfMatch) {
