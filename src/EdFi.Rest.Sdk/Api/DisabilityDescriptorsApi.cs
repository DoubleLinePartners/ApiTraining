  ...
  namespace EdFi.Rest.Api {
    public class DisabilityDescriptorsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<DisabilityDescriptor>> GetDisabilityDescriptorsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<DisabilityDescriptor>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<DisabilityDescriptor> GetDisabilityDescriptorByKey(int? disabilityDescriptorId, string IfNoneMatch) {
        var request = new RestRequest("/disabilityDescriptors", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<DisabilityDescriptor>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DisabilityDescriptor> GetDisabilityDescriptorsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteDisabilityDescriptorById(string id, string IfMatch) {
