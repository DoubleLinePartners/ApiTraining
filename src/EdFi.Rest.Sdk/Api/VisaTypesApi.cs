  ...
  namespace EdFi.Rest.Api {
    public class VisaTypesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<VisaType>> GetVisaTypesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<VisaType>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<VisaType> GetVisaTypeByKey(int? visaTypeId, string IfNoneMatch) {
        var request = new RestRequest("/visaTypes", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<VisaType>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<VisaType> GetVisaTypesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteVisaTypeById(string id, string IfMatch) {
