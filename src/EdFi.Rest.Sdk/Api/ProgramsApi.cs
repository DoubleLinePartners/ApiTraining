  ...
  namespace EdFi.Rest.Api {
    public class ProgramsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Program>> GetProgramsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Program>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Program> GetProgramByKey(int? educationOrganizationId, string type, string name, string IfNoneMatch) {
        var request = new RestRequest("/programs", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Program>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Program> GetProgramsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteProgramById(string id, string IfMatch) {
