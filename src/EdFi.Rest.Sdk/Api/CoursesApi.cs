  ...
  namespace EdFi.Rest.Api {
    public class CoursesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Course>> GetCoursesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Course>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Course> GetCourseByKey(int? educationOrganizationId, string code, string IfNoneMatch) {
        var request = new RestRequest("/courses", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Course>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Course> GetCoursesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteCourseById(string id, string IfMatch) {
