  ...
  namespace EdFi.Rest.Api {
    public class SchoolsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<School>> GetSchoolsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<School>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<School> GetSchoolByKey(int? schoolId, string IfNoneMatch) {
        var request = new RestRequest("/schools", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<School>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<School> GetSchoolsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteSchoolById(string id, string IfMatch) {
