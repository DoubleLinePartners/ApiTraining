  ...
  namespace EdFi.Rest.Api {
    public class GradesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Grade>> GetGradesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Grade>>(request);   
      }
      /// <summary>
      ...
      /// <param name="gradingPeriodEducationOrganizationId">The Education Organization that defines the grading period.</param>
      /// <param name="type">The type of grade (e.g., Exam, Final, Grading Period, Progress Report)</param>
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Grade> GetGradeByKey(string studentUniqueId, int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string termType, int? schoolYear, DateTime? beginDate, string gradingPeriodDescriptor, DateTime? gradingPeriodBeginDate, int? gradingPeriodEducationOrganizationId, string type, string IfNoneMatch) {
        var request = new RestRequest("/grades", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (studentUniqueId == null || schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || termType == null || schoolYear == null || beginDate == null || gradingPeriodDescriptor == null || gradingPeriodBeginDate == null || gradingPeriodEducationOrganizationId == null || type == null ) {
        ...
        return client.Execute<Grade>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Grade> GetGradesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteGradeById(string id, string IfMatch) {
