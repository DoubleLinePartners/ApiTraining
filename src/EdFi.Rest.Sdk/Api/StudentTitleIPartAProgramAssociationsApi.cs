  ...
  namespace EdFi.Rest.Api {
    public class StudentTitleIPartAProgramAssociationsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<StudentTitleIPartAProgramAssociation>> GetStudentTitleIPartAProgramAssociationsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<StudentTitleIPartAProgramAssociation>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<StudentTitleIPartAProgramAssociation> GetStudentTitleIPartAProgramAssociationByKey(string studentUniqueId, string programType, int? programEducationOrganizationId, DateTime? beginDate, string programName, int? educationOrganizationId, string IfNoneMatch) {
        var request = new RestRequest("/studentTitleIPartAProgramAssociations", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<StudentTitleIPartAProgramAssociation>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<StudentTitleIPartAProgramAssociation> GetStudentTitleIPartAProgramAssociationsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteStudentTitleIPartAProgramAssociationById(string id, string IfMatch) {
