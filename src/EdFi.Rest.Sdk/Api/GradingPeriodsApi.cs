  ...
  namespace EdFi.Rest.Api {
    public class GradingPeriodsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<GradingPeriod>> GetGradingPeriodsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<GradingPeriod>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<GradingPeriod> GetGradingPeriodByKey(int? educationOrganizationId, string descriptor, DateTime? beginDate, string IfNoneMatch) {
        var request = new RestRequest("/gradingPeriods", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (educationOrganizationId == null || descriptor == null || beginDate == null ) {
        ...
        return client.Execute<GradingPeriod>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<GradingPeriod> GetGradingPeriodsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteGradingPeriodById(string id, string IfMatch) {
