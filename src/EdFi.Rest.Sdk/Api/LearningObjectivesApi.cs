  ...
  namespace EdFi.Rest.Api {
    public class LearningObjectivesApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<LearningObjective>> GetLearningObjectivesAll(int? offset, int? limit) {
        ...
        return client.Execute<List<LearningObjective>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<LearningObjective> GetLearningObjectiveByKey(string objective, string academicSubjectDescriptor, string objectiveGradeLevelDescriptor, string IfNoneMatch) {
        var request = new RestRequest("/learningObjectives", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<LearningObjective>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<LearningObjective> GetLearningObjectivesById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteLearningObjectiveById(string id, string IfMatch) {
