  ...
  namespace EdFi.Rest.Api {
    public class PayrollsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<Payroll>> GetPayrollsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<Payroll>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<Payroll> GetPayrollByKey(string staffUniqueId, int? educationOrganizationId, string accountNumber, int? fiscalYear, DateTime? asOfDate, string IfNoneMatch) {
        var request = new RestRequest("/payrolls", Method.GET);
        request.RequestFormat = DataFormat.Json;
        ...
        return client.Execute<Payroll>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<Payroll> GetPayrollsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeletePayrollById(string id, string IfMatch) {
