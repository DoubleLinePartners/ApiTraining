  ...
  namespace EdFi.Rest.Api {
    public class DisciplineIncidentsApi {
      ...
      /// <returns></returns>
      public IRestResponse<List<DisciplineIncident>> GetDisciplineIncidentsAll(int? offset, int? limit) {
        ...
        return client.Execute<List<DisciplineIncident>>(request);   
      }
      /// <summary>
      ...
      /// <returns></returns>
      public IRestResponse<DisciplineIncident> GetDisciplineIncidentByKey(int? schoolId, string incidentIdentifier, string IfNoneMatch) {
        var request = new RestRequest("/disciplineIncidents", Method.GET);
        request.RequestFormat = DataFormat.Json;

        // verify required params are set
        if (schoolId == null || incidentIdentifier == null ) {
        ...
        return client.Execute<DisciplineIncident>(request);   
      }
      /// <summary>
      ...
      /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
      /// <returns></returns>
      public IRestResponse<DisciplineIncident> GetDisciplineIncidentsById(string id, string IfNoneMatch) {
      ...
      /// <returns></returns>
      public IRestResponse DeleteDisciplineIncidentById(string id, string IfMatch) {
